...
export default function Grants() {
  ...
  return (
    <>
        ...
        <section className="flex flex-col gap-6 border-b border-outline-variant pb-12">
          ...
          <div className="flex max-w-[700px] flex-col gap-3">
            ...
            <p className="font-body text-[15px] leading-[1.7] text-on-surface-variant">
              ...
              recurring revenue and external ecosystem funding. Each wave funds teams building
              stealth address infrastructure, SDK integrations, and privacy-preserving payment
              tooling.
            </p>
          </div>
          <Link
            to="/grants/showcase"
            className="w-fit font-mono text-[11px] font-semibold uppercase tracking-[1.5px] text-outline underline underline-offset-2 transition-colors hover:text-primary"
          >
      ...
      <div className="mx-auto flex max-w-[1120px] flex-col px-6 pb-10 md:px-12 md:pb-16">
        {/* Current wave */}
        {currentWave && (
